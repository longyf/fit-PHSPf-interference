...
ClassImp(RooMyBW2) 
 ...
 RooMyBW2::RooMyBW2(const char *name, const char *title, 
 ...
 RooMyBW2::RooMyBW2(const RooMyBW2& other, const char* name) :  
 ...
 Double_t RooMyBW2::evaluate() const 
 { 
   ...
   // efficiency
   Double_t eff=0;
   if (m_phi_etap>=1.977&&m_phi_etap<=2.549) eff=2.978-4.139*m_phi_etap+1.883*m_phi_etap*m_phi_etap-0.2766*m_phi_etap*m_phi_etap*m_phi_etap;
